 ...
 * @author fes77
 */
public class LightAnimeSmoke extends AnimationGroup{
    ...
    public LightAnimeSmoke(ParticleSystem system, Vector2 position, Vector2 velocity, int size) {
    ...
    public LightAnimeSmoke(ParticleSystem system, Vector2 position, Vector2 velocity, int size, int density) {
    ...
    public LightAnimeSmoke(ParticleSystem system, Vector2 position, Vector2 velocity, int size, int density, int spread) {
        this(system, position, velocity, size, DEFAULT_LIFESPAN, density, spread, Color.WHITE, CircleParticle.DEFAULT_RGBA_DEFUSION);
    }
    
    public LightAnimeSmoke(ParticleSystem system, Vector2 position, Vector2 velocity, int size, float lifespan, int density, int spread) {
        this(system, position, velocity, size, lifespan, density, spread, Color.WHITE, CircleParticle.DEFAULT_RGBA_DEFUSION);
    }
    
    public LightAnimeSmoke(ParticleSystem system, Vector2 position, Vector2 velocity, int size, int density, int spread, Color color, float[] rgbaDifusion) {
        this(system, position, velocity, size, DEFAULT_LIFESPAN, density, spread, color, rgbaDifusion);
    }
    
    public LightAnimeSmoke(ParticleSystem system, Vector2 position, Vector2 velocity, int size, float lifespan, int density, int spread, Color color, float[] rgbaDifusion) {
...
//        particles = new LinkedList();
    ...
    public LightAnimeSmoke(ParticleSystem system, Vector2 position, Vector2 velocity, Vector2 acceleration, int size, int density, int spread) {
    ...
    public LightAnimeSmoke(ParticleSystem system, Vector2 position, Vector2 velocity, Vector2 acceleration, int size, int density, int spread, Color color, float[] rgbaDifusion) {
        this(system, position, velocity, acceleration, size, DEFAULT_LIFESPAN, density, spread, color, rgbaDifusion);
    }
    
    public LightAnimeSmoke(ParticleSystem system, Vector2 position, Vector2 velocity, Vector2 acceleration, int size, float lifespan, int density, int spread, Color color, float[] rgbaDifusion) {
        super(system, position, velocity, size, lifespan, density);
        this.spread = spread;
        this.color = color;
        this.rgbaDifusion = rgbaDifusion;
    ...
    public LightAnimeSmoke(ParticleSystem system, int size, int density, int spread) {
...
//    }
    ...
    public static void main(String[] argv) throws InterruptedException
    {
        ...
        LightAnimeSmoke smoke = new LightAnimeSmoke(system, new Vector2(200, 700), new Vector2(0, -80), 50, 10, 20, Color.WHITE, new float[]{1, 6, 20, 0.3f});
